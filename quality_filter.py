...
class QualityFilter:
    """Filtro de calidad con criterios configurables."""
    ...
    def _overlap_ratio(seg_start: float, seg_end: float, diar_df: Optional[pd.DataFrame]) -> float:
        ...
        # Aproximación: si hay más de un segmento diarizado cubriendo el mismo instante,
        # contabilizamos ese tiempo como potencial overlap.
        events = []
